...
public class RelativizeTest01 {
    public static void main(String[] args) {
        ...
        System.out.println("5 " + absoluto1.relativize(relativo1));//Cuidado ao utilizar caminho absoluto com relativo, como o relativo nao tem uma localizacao definida o java se perde para procurar
